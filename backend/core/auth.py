...
class APIKeyManager:
    ...
    def verify_api_key(api_key: str, hashed_key: str) -> bool:
        ...
        return secrets.compare_digest(APIKeyManager.hash_api_key(api_key), hashed_key)
...
class AuthCredentials:
    ...
    def _initialize_defaults(self) -> None:
        ...
        default_api_key = "ng_default_key"
    ...
    def add_api_key(
        self, api_key: str, role: str, name: str, created_by: str = "system"
    ) -> dict[str, Any]:
        """Add a new API key."""
        hashed_key = APIKeyManager.hash_api_key(api_key)
